...
public class SkillArea {
	...
	@Column(name = "AddOnDiscount")
	private Float addOnDescount;
	...
	/**
	 * @param skillAreaId the skillAreaId to set
	 */
	...
	/**
	 * @return the addOnDescount
	 */
	public Float getAddOnDescount() {
		return addOnDescount;
	}

	/**
	 * @param addOnDescount the addOnDescount to set
	 */
	public void setAddOnDescount(Float addOnDescount) {
		this.addOnDescount = addOnDescount;
	}
